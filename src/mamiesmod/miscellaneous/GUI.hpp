...
namespace misc {
    extern uint32_t TextColorIndex;
    ...
    public:
        ...
        static void drawRoundedBox(float x, float y, float width, float height, float cornerRadius, int rgb, int opacity, int seg = 20) {
            float startX = x;
            float startY = y;
            float sizeX = width;
            float sizeY = height;
