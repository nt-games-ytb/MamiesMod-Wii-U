...
#include "../minecraft/util/MallocOperator.hpp"
#include "Vector.hpp"
...
namespace misc {
    ...
    public:
        ...
        void operator+=(String<T> other) {
            string = (misc::String<T>(string) + other.c_str()).c_str();
            size += other.length();
        }

        void operator+=(T other) {
            string = (misc::String<T>(string) + other).c_str();
            size++;
        }
    ...
    typedef misc::String<wchar_t> WString;
}