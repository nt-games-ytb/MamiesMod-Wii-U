...
#include "buffer/BufferedImage.hpp"
#include "../../miscellaneous/types.hpp"
...
namespace mc {
    ...
    public:
        ...
        static void disableAlphaTest() {
            return code::Func<void, 0x03108E10>()();
        }
        ...
        static void bindTexture(int i0) {
            code::Func<void, 0x030E4750, int>()(i0);
        }
        ...
        static void alphaFunc(int32_t i0, float32_t f0) {
            code::Func<void, 0x031056D8, int32_t, float32_t>()(i0, f0);
        }

        static void depthFunc(int32_t i0) {
            code::Func<void, 0x030E9BD4, int32_t>()(i0);
        }
    };
}