...
typedef struct menu_s {
    ...
    uint32_t color;
    uint32_t opacity;
    uint32_t menu_tab_index;
    uint32_t player_tab_index;
    uint32_t player_other_tab_index;
    uint32_t player_visual_tab_index;
    uint32_t player_settings_tab_index;
    uint32_t player_pvp_tab_index;
    uint32_t world_tab_index;
    uint32_t world_options_tab_index;
    uint32_t world_generation_tab_index;
    uint32_t world_entities_tab_index;
    uint32_t world_liquids_tab_index;
    uint32_t world_infinite_tab_index;
    uint32_t world_enchant_tab_index;
    uint32_t world_other_tab_index;
    uint32_t minigames_tab_index;
    uint32_t nicknames_tab_index;
    uint32_t build_tab_index;
    uint32_t other_tab_index;
    uint32_t settings_tab_index;
    bool tab_changed;
...
void display_coordinates(float size, float x, float y, uint32_t precision, uint32_t color);
